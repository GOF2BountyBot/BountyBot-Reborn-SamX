...
def upgrade() -> None:
    ...
    if not column_exists("guild_configs", "bounty_max_per_tier"):
        op.add_column(
            "guild_configs",
            sa.Column(
                "bounty_max_per_tier",
    ...
    if not column_exists("guild_configs", "bounty_expiry_minutes"):
        op.add_column(
            "guild_configs",
            sa.Column(
    ...
    if not column_exists("guild_configs", "bounty_spawn_interval_minutes"):
        op.add_column(
            "guild_configs",
            sa.Column(
    ...
    if not column_exists("guild_configs", "next_spawn_check_at"):
        op.add_column(
            "guild_configs",
            sa.Column(
                "next_spawn_check_at",
...
def downgrade() -> None:
    ...
    if column_exists("guild_configs", "next_spawn_check_at"):
        op.drop_column("guild_configs", "next_spawn_check_at")
    if column_exists("guild_configs", "bounty_spawn_interval_minutes"):
        op.drop_column("guild_configs", "bounty_spawn_interval_minutes")
    if column_exists("guild_configs", "bounty_expiry_minutes"):
        op.drop_column("guild_configs", "bounty_expiry_minutes")
    if column_exists("guild_configs", "bounty_max_per_tier"):
