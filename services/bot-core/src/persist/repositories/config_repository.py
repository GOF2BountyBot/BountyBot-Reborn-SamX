    ...
    async def get_config_summary(self, db: AsyncSession, guild_id: int) -> dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "cloak_set_value": config.cloak_set_value,
                "booster_accuracy_debuff_factor": config.booster_accuracy_debuff_factor,
                "thruster_accuracy_bonus_factor": config.thruster_accuracy_bonus_factor,
                "auto_turret_accuracy_multiplier": config.auto_turret_accuracy_multiplier,
                "player_base_accuracy": config.player_base_accuracy,
                "npc_base_accuracy": config.npc_base_accuracy,
                "scanner_tier_b_bonus_pp": config.scanner_tier_b_bonus_pp,
                "scanner_tier_c_bonus_pp": config.scanner_tier_c_bonus_pp,
                "starting_distance_m": config.starting_distance_m,
                "base_ship_speed_mps": config.base_ship_speed_mps,
                "min_distance_m": config.min_distance_m,
                "thruster_window_m": config.thruster_window_m,
                "emergency_system_invuln_s": config.emergency_system_invuln_s,
                "nuke_magnitude_scale": config.nuke_magnitude_scale,
                "nuke_friendly_factor": config.nuke_friendly_factor,
                "nuke_range_regime_threshold_m": config.nuke_range_regime_threshold_m,
                "nuke_lr_near_frac": config.nuke_lr_near_frac,
                "nuke_cr_short_m": config.nuke_cr_short_m,
                "nuke_cr_overshoot_m": config.nuke_cr_overshoot_m,
                "nuke_stack_falloff": config.nuke_stack_falloff,
                "shock_blast_trigger_range_m": config.shock_blast_trigger_range_m,
                "combat_layer_reemit_fraction": config.combat_layer_reemit_fraction,
            }
