...
- `*_RETENTION_*` — db_retention windows (`BOUNTY_RETENTION_HOURS`, `DUEL_RETENTION_HOURS`, `AUDIT_RETENTION_DAYS`, `COMBAT_LOG_BOUNTY_RETENTION_HOURS`, `COMBAT_LOG_PVP_RETENTION_HOURS`)
