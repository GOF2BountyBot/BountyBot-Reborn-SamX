...
| `bounty.py` | `Bounty` | `bounty` | id, guild_id, division, criminal_name, criminal_faction, route (JSONB), answer, reward, reward_per_sys, checked (JSONB), issue_time, end_time, tech_level, criminal_ship (JSONB), status, escape_count, win_user_id, respawn_time, criminal_current_hull/armour/shield + criminal_last_damage_at (Phase-2 damage state, rev 0009), created_at, updated_at |
