...
|---|---|---|---|
| 0 Pre-flight | ✅ | | API-driven: stack healthy, data load OK, migration 0012 confirmed |
| 1 Reseed data / about | ✅ | | turret damage_per_shot present; typed secondary fields present (see findings) |
| 2 PvC bounty combat | ✅ | | `/check` resolved + persisted; pvc_dr=0.33; 1752-event timeline |
| 3 PvP duels | ✅ | | challenge+accept resolved + persisted; pvc_dr=0.0; stakes transferred |
| 4 Weapon classes | ⏳ | | resolver branches verified in code; live equip-and-fight not yet run |
| 5 Modules | ⏳ | | not yet run |
| 6 Edge cases | ⏳ | | not yet run |
| 7 Smoke (unmodified) | ⏳ | | Discord-side / your pass |
| 8 Persistence / DB | ✅ | | combat_log rows #1 (PvC) #2 (PvP); no variance_percent; 0012 columns gone |
