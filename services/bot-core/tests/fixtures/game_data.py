...
def get_seed_ships() -> list[SimpleNamespace]:
    ...
    return [
        SimpleNamespace(
            ...
            texture_regions=1,
            save_due=False,
            model="/app/data/game-objects/items/ships/Midorian/Betty.bbship/Betty_Full.obj",
            norm_spec="/app/data/game-objects/items/ships/Midorian/Betty.bbship/ship_000_midorian_normal_specular.bmp",
            value=16038,
            wiki="https://galaxyonfire.fandom.com/wiki/Betty",
            assets=[
                "/app/data/game-objects/items/ships/Midorian/Betty.bbship/Betty_Full.mtl",
                "/app/data/game-objects/items/ships/Midorian/Betty.bbship/Betty_Full.obj",
            ],
        ),
        SimpleNamespace(
            id=2,
            ...
            texture_regions=2,
            save_due=False,
            model="/app/data/game-objects/items/ships/Terran/Groza.bbship/Groza_Full.obj",
            norm_spec="/app/data/game-objects/items/ships/Terran/Groza.bbship/ship_022_terran_normal_specular.bmp",
            value=251600,
            wiki="https://galaxyonfire.fandom.com/wiki/Groza",
            assets=[
                "/app/data/game-objects/items/ships/Terran/Groza.bbship/Groza_Full.mtl",
                "/app/data/game-objects/items/ships/Terran/Groza.bbship/Groza_Full.obj",
            ],
        ),
        SimpleNamespace(
            id=3,
            ...
            texture_regions=1,
            save_due=False,
            model="/app/data/game-objects/items/ships/Nivelian/Ghost.bbship/Ghost_Full.obj",
            norm_spec="/app/data/game-objects/items/ships/Nivelian/Ghost.bbship/ship_061_elite_nivelian_prototype_normal_specular.bmp",
            value=6000000,
            wiki="https://galaxyonfire.fandom.com/wiki/Ghost",
            assets=[
                "/app/data/game-objects/items/ships/Nivelian/Ghost.bbship/Ghost_Full.mtl",
                "/app/data/game-objects/items/ships/Nivelian/Ghost.bbship/Ghost_Full.obj",
            ],
        ),
        SimpleNamespace(
            id=4,
            ...
            texture_regions=2,
            save_due=False,
            model="/app/data/game-objects/items/ships/Pirate/Mantis.bbship/Mantis_Full.obj",
            norm_spec="/app/data/game-objects/items/ships/Pirate/Mantis.bbship/ship_029_pirates_normal_specular.bmp",
            value=4136800,
            wiki="https://galaxyonfire.fandom.com/wiki/Mantis",
            assets=[
                "/app/data/game-objects/items/ships/Pirate/Mantis.bbship/Mantis_Full.mtl",
                "/app/data/game-objects/items/ships/Pirate/Mantis.bbship/Mantis_Full.obj",
            ],
        ),
        SimpleNamespace(
            id=5,
            ...
            texture_regions=1,
            save_due=False,
            model="/app/data/game-objects/items/ships/Vossk/Cargo_Vossk.bbship/Cargo_Vossk_Full.obj",
            norm_spec=None,
            value=700000,
            wiki="https://galaxyonfire.fandom.com/wiki/Freighter",
            assets=[
                "/app/data/game-objects/items/ships/Vossk/Cargo_Vossk.bbship/Cargo_Vossk_Full.mtl",
                "/app/data/game-objects/items/ships/Vossk/Cargo_Vossk.bbship/Cargo_Vossk_Full.obj",
            ],
        ),
    ]
