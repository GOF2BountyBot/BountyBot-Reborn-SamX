...
def upgrade() -> None:
    ...
    op.execute("UPDATE guild_configs SET hunting_channel_id = general_channel_id WHERE general_channel_id IS NOT NULL")
...
def downgrade() -> None:
    ...
    op.execute("UPDATE guild_configs SET general_channel_id = hunting_channel_id WHERE hunting_channel_id IS NOT NULL")
